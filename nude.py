    ...
    def resize(self,maxwidth=1000,maxheight=1000):
        ...
        if maxwidth:
            if self.width > maxwidth:
                ...
                self.image = self.iamge.resize((maxwidth,hsize),Image.LANCZOS)
        ...
        if maxheight:
            if self.height > maxheight:
                ...
                wsize = int((float(self.width)*float(hepercent)))
                fname = self.image.filename
